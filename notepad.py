...
def Open():
        root.filename = filedialog.askopenfilename(
                initialdir = '/',
                title="Open file.",
                filetypes=(("Root bad","*.rod"),("txt file","*.txt"),("Python file","*.py"),("C# file","*.cs"),("all files","*.*")))
...
# ================================ Exit Code =====================================
def exit():
        message = messagebox.askquestion('Root bad',"Do you want to save changes.")
        if message == "yes":
                save_as()
        else:
                root.destroy()
...
#=========================== Delete all code =============================
def delete():
        message = messagebox.askquestion('Root bad',"Do you want to Delete all?")
        if message == "yes":
                text.delete('1.0','end')
        else:
               return "break"
...
def fonts():
        ...
        size['values'] = (8,9,10,12,15,20,23,25,27,30,35,40,43,47,50,55,65,76,80,90,100,150,200,250,300)
...
Help.add_command(label="View Help",command=view_help)
Help.add_command(label="Send FeedBack",command=send_feedback)
Help.add_command(label="About Root bad")
